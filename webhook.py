...
#The first command layout can attach or write the logfile to the message/embed.
#The second command layout just sends an embed notifying that something ended successfully or failed.
